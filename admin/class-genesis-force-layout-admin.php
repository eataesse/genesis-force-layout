 ...
 * @subpackage Genesis_Force_Layout/admin
 */
 ...
 */
class Genesis_Force_Layout_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/genesis-force-layout-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/genesis-force-layout-admin.js', array( 'jquery' ), $this->version, false );
    ...
    public function display_plugin_setup_page() {
        include_once( 'partials/genesis-force-layout-admin-display.php' );
    }
    ...
    public function validate($input) {
        ...
        //Cleanup
        $valid['force-layout'] = (isset($input['force-layout']) && !empty($input['force-layout'])) ? 1 : 0;
